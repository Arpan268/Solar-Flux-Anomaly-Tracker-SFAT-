    ...
    return (
        <div className="max-w-7xl mx-auto mt-12 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div onClick={() => navigate('/supervisor/view-anomalies')} className="bg-gray-800/40 border border-gray-700 rounded-xl p-8 hover:bg-gray-800 hover:border-blue-500 transition-colors cursor-pointer group">
                    <div className="mb-4">
                ...
                <div onClick={() => navigate('/supervisor/send-instructions')} className="bg-gray-800/40 border border-gray-700 rounded-xl p-8 hover:bg-gray-800 hover:border-emerald-500 transition-colors cursor-pointer group">
                    <div className="mb-4">
                ...
                <div onClick={() => navigate('/supervisor/view-operators')} className="bg-gray-800/40 border border-gray-700 rounded-xl p-8 hover:bg-gray-800 hover:border-purple-500 transition-colors cursor-pointer group">
                    <div className="mb-4">
